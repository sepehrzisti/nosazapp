...
function PostSabAddItem() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/sab/', formData, {
                headers: {
    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    <label htmlFor="slids"> تعداد اسلب ها :</label>
                    <input
                        id="slids"
                        type="text"
                        name="slids"
