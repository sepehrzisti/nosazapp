...
function PostAddItemMaterialFrontWork() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/manager/matrialfrontwork/', formData, {
                headers: {
        ...
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    <label htmlFor="cut_code">کد کوپ :</label>
                    <input
                        id="cut_code"
                        type="text"
                        name="cut_code"
                ...
                <div className="form-group">
                    <label htmlFor="tori_active">تاریخ و زمان:</label>
                    <input
                        id="tori_active"
                        type="checkbox"
                        name="tori_active"
...
export default PostAddItemMaterialFrontWork;