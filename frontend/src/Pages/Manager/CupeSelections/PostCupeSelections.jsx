...
function PostAddItemCupeSelection() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/manager/stonductionstone/', formData, {
                headers: {
...
export default PostAddItemCupeSelection;