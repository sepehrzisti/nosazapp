...
function PostCutAddItem() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/cut/', formData, {
                headers: {
    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    <label htmlFor="NumbersCut">تعداد برش:</label>
                    <input
                        id="NumbersCut"
                        type="text" 
                        name="NumbersCut"
                        value={formData.NumbersCut}
                        onChange={handleChange}
                        required
                    />
                </div>
                ...
                <div className="form-group">
                    <label htmlFor="CutNote">نوشته:</label>
                    <input
                        id="CutNote"
                        type="text"
                        name="CutNote"
                        value={formData.CutNote}
                        onChange={handleChange}
                        required
                    />
                </div>
